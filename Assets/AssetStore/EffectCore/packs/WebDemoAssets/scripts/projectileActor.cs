...
public class projectileActor : MonoBehaviour {
   ...
   // public ParticleSystem muzzleflare;
	...
	void Update ()
    {
        ...
        //firingTimerが溜まったら打てるrapidfireがtrueで
        ...
        //if (playerController.currentWeapon.rapidFire && firing)
        //{
        //    if (firingTimer > playerController.currentWeapon.rapidFireCooldown + rapidFireDelay)
        //    {
        //        //Fire();
        //        firingTimer = 0;
        //    }
...
//        recoilAnimator.SetTrigger("recoil_trigger");
        ...
        rocketInstance.AddForce(spawnLocator.forward * Random.Range(playerController.currentWeapon.min, playerController.currentWeapon.max) * 3);
